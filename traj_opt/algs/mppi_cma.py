...
class MPPI_CMA(SamplingBasedController):
    ...
    def __init__(
        ...
        self.ndims = self.num_knots * self.task.model.nu
    ...
    def init_params(
        ...
        perturbation = jnp.zeros((self.num_samples, self.ndims))
        
        covariance = jnp.eye((self.ndims)) * (self.noise_level**2)
        
        return MPPI_CMA_Params(tk=_params.tk, mean=_params.mean, rng=_params.rng, 
                               perturbation=perturbation,
                               covariance=covariance)

    def sample_knots(self, params: MPPI_CMA_Params) -> Tuple[jax.Array, MPPI_CMA_Params]:
